...
class Triangle extends Shape {
  ...
  render() {
    ...
    const triangleContent = `<polygon points="150,20 50,180 250,180" fill="${this.shapeColor}" />`;
...
class Square extends Shape {
  ...
  render() {
    const parentContent = super.render();
    const rectangleContent = `<rect x="10" y="10" width="100" height="100" fill="${this.shapeColor}"/>`;
